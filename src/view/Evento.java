...
public class Evento extends JFrame {
	...
	public Evento() {
		...
		JLabel lblNewLabel_3 = new JLabel("Duracao");
		...
		JRadioButton rdbtnNewRadioButton = new JRadioButton("Aula");
		...
		JRadioButton rdbtnNewRadioButton_1 = new JRadioButton("Monitoria");
